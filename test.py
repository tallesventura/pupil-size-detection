...
#preProcessing.run(np.arange(1,205),orig_path,path_gray,path_bin)
...
circles_raw = circles_utils.generate_circles([1, 99, 36, 10],path_gray,np.arange(1,n_images+1),27,70)
...
plt.plot(np.array(indexes)/2,percentage_areas,'b', label='470 nm, 8 uW',linewidth=3.0)

plt.xlabel("Time (sec.)")
plt.ylabel('% \of Baseline Area')
plt.axis([0,int(n_images/2),0,250])
